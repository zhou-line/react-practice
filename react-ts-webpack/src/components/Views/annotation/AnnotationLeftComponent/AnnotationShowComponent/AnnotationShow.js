...
import AnnotationModel from "./AnnotationModelCompenet/annotationModel";
import {setLoading, setPicAnnotations, setRecs} from "../../../redux/actions/picAction";
import {getRec} from "../../util";
import {ExclamationCircleFilled} from "@ant-design/icons";
import {message, Modal, Spin} from "antd";


export default function AnnotationShowComponent(props) {
...
// 添加矩形
    ...
    const showDeleteConfirm = (ids) => {
        confirm({
            ...
            cancelText: '取消',
            onOk() {
               REST.deleteAnnotation(ids).then((res) => {
